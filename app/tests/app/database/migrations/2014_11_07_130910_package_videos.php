...
class PackageVideos extends Migration {
	...
	private function modules() {
		DB::table('modules')->insert(
			array(
				...
				'modul_title' => 'Videos',
				'helper' => 'VideoHelper',
				'admin_route' => '/administrator/video',
				'has_public' => 1,
	...
	private function routings() {
		$this->routingIds[0] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/video',
		...
		$this->routingIds[1] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/video/{id}',
				'layout_name' => 'leftright',
				'active' => 1,
				'needover18' => 0,
				'need_auth' => 0,
