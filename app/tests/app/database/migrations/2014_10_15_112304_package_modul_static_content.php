...
class PackageModulStaticContent extends Migration {
	...
	private function modules() {
		DB::table('modules')->insert(
			array(
				'modul_name' => 'StaticContent',
				'modul_title' => 'Static Content',
				'helper' => 'StaticContentHelper',
				'admin_route' => '/administrator/staticcontent',
				'has_public' => 1,
	...
	private function routings() {
		$this->routingIds[0] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/staticcontent',
		...
		$this->routingIds[1] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/staticcontent/{id}',
				'layout_name' => 'leftright',
				'active' => 1,
				'needover18' => 0,
				'need_auth' => 0,
	...
	private function contents() {
		...
		DB::table('contents')->insert(
			array(
				...
				'modul' => 'Custom',
				'helper_function' => 'getAdminDatas',
				'helper_class' => 'StaticContentHelper',
				#'helper_data_json' => 1,
				#'routing_data_json' => 1,
				'active' => 1,
				'created_at' => date('Y-m-d h:i:s'),
