...
class PackageModulOldalkezelo extends Migration {
	...
	private function modules() {
		DB::table('modules')->insert(
			array(
				'modul_name' => 'Oldalkezelo',
				'modul_title' => 'Site Management',
				'helper' => 'OldalkezeloHelper',
				'admin_route' => '/administrator/oldalkezelo',
				'has_public' => 0,
	...
	private function routings() {
		$this->routingIds[0] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/oldalkezelo',
		...
		$this->routingIds[1] = DB::table('routings')->insertGetId(
			array(
				'routing_path' => '/administrator/oldalkezelo/{id}',
				'layout_name' => 'leftright',
				'active' => 1,
				'needover18' => 0,
				'need_auth' => 0,
	...
	private function contents() {
		...
		DB::table('contents')->insert(
			array(
				...
				'modul' => 'Custom',
				'helper_function' => 'getAdminDatas',
				'helper_class' => 'OldalkezeloHelper',
				#'helper_data_json' => 1,
				#'routing_data_json' => 1,
				'active' => 1,
				'created_at' => date('Y-m-d h:i:s'),
